...
func TestEAASUnauthorizedAccessToObject(t *testing.T) {
	...
	_, err = client.GetPermissions(oidEncrypted)
	failOnSuccess("Unauthorized user got permissions", err, t)
	checkStatusCode(err, codes.PermissionDenied, t)

	err = client.AddPermission(oidEncrypted, uid)
	failOnSuccess("Unauthorized user added permission", err, t)
	checkStatusCode(err, codes.PermissionDenied, t)

	err = client.RemovePermission(oidEncrypted, uid)
	failOnSuccess("Unauthorized user removed permission", err, t)
	checkStatusCode(err, codes.PermissionDenied, t)
}

func TestEAASUnauthorizedToRead(t *testing.T) {
	client, err := coreclient.NewClient(context.Background(), endpoint, certPath)
	failOnError("Could not create client", err, t)
	defer client.Close()
...
func TestEAASUnauthorizedToCreate(t *testing.T) {
	client, err := coreclient.NewClient(context.Background(), endpoint, certPath)
	failOnError("Could not create client", err, t)
	defer client.Close()
...
func TestEAASUnauthorizedToGetPermissions(t *testing.T) {
	client, err := coreclient.NewClient(context.Background(), endpoint, certPath)
	failOnError("Could not create client", err, t)
	defer client.Close()
...
func TestEAASUnauthorizedToManagePermissions(t *testing.T) {
	client, err := coreclient.NewClient(context.Background(), endpoint, certPath)
	failOnError("Could not create client", err, t)
	defer client.Close()
...
func TestEAASUnauthorizedToManageUsers(t *testing.T) {
	client, err := coreclient.NewClient(context.Background(), endpoint, certPath)
	failOnError("Could not create client", err, t)
	defer client.Close()
